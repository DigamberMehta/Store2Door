...
export const registerDriver = asyncHandler(async (req, res) => {
  ...
  // Create user with delivery_rider role
...
export const loginDriver = asyncHandler(async (req, res) => {
  ...
  // Find user by email or phone with delivery_rider role
...
/**
 * @desc    Refresh token
 * @route   POST /api/drivers/refresh
 * @access  Public
 */
 ...
 * @route   POST /api/drivers/forgot-password
 * @access  Public
 */
...
/**
 * @desc    Reset password
 * @route   PUT /api/drivers/reset-password
 * @access  Public
 */
